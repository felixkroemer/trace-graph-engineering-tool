package com.felixkroemer.trace_graph_engineering_tool.render.immed;
...
import com.felixkroemer.trace_graph_engineering_tool.render.immed.arrow.*;
import com.felixkroemer.trace_graph_engineering_tool.render.immed.nodeshape.*;
import com.felixkroemer.trace_graph_engineering_tool.render.stateful.LabelLineInfo;
...
public final class GraphGraphics {
    ...
    public final Shape drawNodeFull(final byte nodeShape, final float xMin, final float yMin, final float xMax,
        ...
        if (debug) {
            ...
            if (!((6.0d * borderWidth) <= Math.min(((double) xMax) - xMin, ((double) yMax) - yMin))) {
                throw new IllegalArgumentException("borderWidth is not less than the minimum of node width and node " +
    ...
    public final void drawEdgeFull(final ArrowShape arrow0Type, final float arrow0Size, final Paint arrow0Paint,
								   ...
								   final float x0, final float y0, EdgeAnchors anchors, final float x1, final float y1
    ...
    private final void drawSimpleEdgeFull(final ArrowShape arrow0Type, final float arrow0Size,
										  final Paint arrow0Paint, final ArrowShape arrow1Type, final float arrow1Size
			, final Paint arrow1Paint, final float x0, final float y0, final float x1, final float y1,
    ...
    private static int computeCubicPolyEdgePath(double[] edgePtsBuff, float[] floatBuff, ArrowShape arrow0Type,
												...
												float y0, EdgeAnchors anchors, float x1, float y1,
												double curveFactor) {
