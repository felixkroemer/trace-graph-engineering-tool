...
public interface EdgeDetails {
     ...
     */
    default Double getLabelRotation(View<CyEdge> edge) {
        return 0d;
    }
     ...
     * return null if this method is called by the rendering engine.
     */
    default Double getLabelRotation(View<CyEdge> edge, double rise, double run) {
        return 0d;
    }
     ...
     */
    default boolean getLabelAutorotate(View<CyEdge> edge) {
        return false;
    }
