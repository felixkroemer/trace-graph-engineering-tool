...
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.canvas.SelectionCanvas;
...
public class FrameRatePanel extends BasicCollapsiblePanel {
    ...
    private void createContents() {
        ...
        layout.setHorizontalGroup(layout.createParallelGroup().addComponent(frameRateLabel).addComponent(scrollPane,
				PREFERRED_SIZE, PREFERRED_SIZE, Short.MAX_VALUE));

        layout.setVerticalGroup(layout.createSequentialGroup().addComponent(frameRateLabel).addComponent(scrollPane));
    ...
    private int flattenAndExtract(int i, int depth, long frameTot, Object[][] data, DebugFrameInfo parent,
