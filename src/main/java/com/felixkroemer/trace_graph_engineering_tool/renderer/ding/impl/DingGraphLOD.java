...
public class DingGraphLOD implements GraphLOD, PropertyUpdatedListener {
    ...
    private boolean shouldUpdateProps(String currentVersionString, String lastUpdatedVersionString) {
        ...
        if (lastUpdatedVersionString == null) return true;
    ...
    public void handleEvent(PropertyUpdatedEvent e) {
        if (!e.getSource().equals(cyProp)) return;
     ...
     *
     * @param visibleNodeCount the number of nodes visible in the current viewport; note that
     *                         a visible node is not necessarily a rendered node, because
     *                         visible nodes with zero width or height are not rendered.
     * @param totalNodeCount   the total number of nodes in the graph that is being rendered.
     * @param totalEdgeCount   the total number of edges in the graph that is being rendered.
