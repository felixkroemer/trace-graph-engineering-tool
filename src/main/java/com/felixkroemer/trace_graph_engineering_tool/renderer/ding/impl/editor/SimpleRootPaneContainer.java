...
public class SimpleRootPaneContainer extends JComponent implements RootPaneContainer {
    ...
    public void remove(Component comp) {
        ...
        if (oldCount == getComponentCount()) getContentPane().remove(comp);
    }

    /**
     * Overridden to conditionally forward the call to the <code>contentPane</code>.
     * Refer to {@link RootPaneContainer} for more information.
     */
    @Override
     ...
     * of the frame, refer to {@link RootPaneContainer} for details.
     */
    @Override
