...
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.action.GraphicsDetailAction;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.debug.DingDebugMediator;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.dependency.CustomGraphicsSizeDependencyFactory;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.dependency.EdgeColorDependencyFactory;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.dependency.NodeSizeDependencyFactory;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.*;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.canvas.NetworkImageFactoryImpl;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.cyannotator.AnnotationClipboard;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.cyannotator.AnnotationFactoryManager;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.cyannotator.AnnotationManagerImpl;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.cyannotator.AnnotationTree;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.cyannotator.create.*;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.cyannotator.tasks.*;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.cyannotator.ui.AnnotationMediator;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.editor.EdgeBendEditor;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.editor.EdgeBendValueEditor;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.editor.ObjectPositionVisualPropertyEditor;
...
public class CyActivator extends AbstractCyActivator {
    ...
    private void startPresentationImpl(BundleContext bc, CyServiceRegistrar serviceRegistrar) {
        ...
        var netViewFactory = netViewFactoryProvider.createNetworkViewFactory(dVisualLexicon, DingRenderer.ID,
                viewFactoryConfig);

        var dingNetViewFactory = new DingNetworkViewFactory(netViewFactory, dVisualLexicon, annotationFactoryManager,
        ...
        // Edge Bend editor
        var edgeBendValueEditor = new EdgeBendValueEditor(dingNetViewFactory, dingRenderingEngineFactory,
                serviceRegistrar);
        registerAllServices(bc, edgeBendValueEditor);

        var edgeBendEditor = new EdgeBendEditor(edgeBendValueEditor, continuousMappingCellRendererFactory,
                serviceRegistrar);
        registerService(bc, edgeBendEditor, VisualPropertyEditor.class);

        // Annotation Manager
        registerServiceListener(bc, annotationFactoryManager::addAnnotationFactory,
                annotationFactoryManager::removeAnnotationFactory, AnnotationFactory.class);
        ...
        registerServiceListener(bc, annotationMediator::addAnnotationFactory,
                annotationMediator::removeAnnotationFactory, AnnotationFactory.class);
        ...
        {
            var factory = new ReorderSelectedAnnotationsTaskFactory(renderer, AnnotationTree.Shift.TO_FRONT);
            var props = new Properties();
            props.setProperty(PREFERRED_MENU, NETWORK_EDIT_MENU);
        ...
        {
            var factory = new ReorderSelectedAnnotationsTaskFactory(renderer, AnnotationTree.Shift.UP_ONE);
            var props = new Properties();
            props.setProperty(PREFERRED_MENU, NETWORK_EDIT_MENU);
        ...
        {
            var factory = new ReorderSelectedAnnotationsTaskFactory(renderer, AnnotationTree.Shift.DOWN_ONE);
            var props = new Properties();
            props.setProperty(PREFERRED_MENU, NETWORK_EDIT_MENU);
        ...
        {
            var factory = new ReorderSelectedAnnotationsTaskFactory(renderer, AnnotationTree.Shift.TO_BACK);
            var props = new Properties();
            props.setProperty(PREFERRED_MENU, NETWORK_EDIT_MENU);
        ...
        // -------------------------- Annotation Commands ----------------------------- //
        {
            ...
            props.setProperty(COMMAND_LONG_DESCRIPTION, "List all annotations, or annotations for the specified view,"
                    + " if provided.");
            props.setProperty(COMMAND_EXAMPLE_JSON, "[{\"canvas\":\"foreground\",\"name\":\"Text\"," + "\"type" +
                    "\":\"org.cytoscape.view.presentation.annotations.TextAnnotation\"," + "\"uuid\":\"e643934f-cf94" + "-4ab8-affe-b86675034bee\"" + "\"x\":\"2807.0\",\"y\":\"1268.0\",\"z\":\"0\"}]");
...

        {
            ...
            props.setProperty(COMMAND_LONG_DESCRIPTION, "Adds a shape annotation to a view.  The view must be " +
                    "specified.");
            props.setProperty(COMMAND_EXAMPLE_JSON, "{" + "\"edgeThickness\": \"4.0\"," + "\"canvas\": " +
                    "\"foreground\"," + "\"fillOpacity\": \"100.0\"," + "\"rotation\": \"0.0\"," + "\"type\": \"org" + ".cytoscape.view.presentation.annotations.ShapeAnnotation\"," + "\"uuid\": \"177c3b25-a138-4734" + "-99f4-94316dd555c7\"," + "\"fillColor\": \"#9999FF\"," + "\"shapeType\": \"RECTANGLE\"," + "\"edgeColor\": \"#000000\"," + "\"edgeOpacity\": \"100.0\"," + "\"name\": \"Shape 1\"," + "\"x\":" + " \"2735.0\"," + "\"width\": \"152.0\"," + "\"y\": \"1221.0761988896875\"," + "\"z\": \"2\"," + "\"height\": \"171.0\"" + "}");
...

        {
            ...
            props.setProperty(COMMAND_LONG_DESCRIPTION, "Adds a text annotation to a view.  The view must be " +
                    "specified. ");
            props.setProperty(COMMAND_EXAMPLE_JSON,
                    "{" + "\"canvas\": \"foreground\"," + "\"color\": \"#000000\"," + "\"rotation\": \"0.0\"," +
                            "\"type\": \"org.cytoscape.view.presentation.annotations.TextAnnotation\"," +
                            "\"fontStyle" + "\": \"plain\"," + "\"uuid\": \"e643934f-cf94-4ab8-affe-b86675034bee\"," + "\"fontFamily" + "\": \"Abyssinica SIL\"," + "\"name\": \"Text\"," + "\"x\": \"2807.0\"," + "\"y\": \"1268" + ".0\"," + "\"z\": \"0\"," + "\"fontSize\": \"74\"," + "\"text\": \"Text\"" + "}");
...

        {
            ...
            props.setProperty(COMMAND_LONG_DESCRIPTION, "Adds a bounded text annotation to a view.  The view must be "
                    + "specified.");
            props.setProperty(COMMAND_EXAMPLE_JSON, "{" + "\"edgeThickness\": \"1.0\"," + "\"canvas\": " +
                    "\"foreground\"," + "\"fillOpacity\": \"50.0\"," + "\"color\": \"#000000\"," + "\"rotation\": " + "\"0" + ".0\"," + "\"type\": \"org.cytoscape.view.presentation.annotations" + ".BoundedTextAnnotation\"," + "\"fontStyle\": \"0\"," + "\"uuid\": \"8f5d3f59-d023-4522-bfb5" + "-164794b233cf\"," + "\"fillColor\": " + "\"#FF66FF\"," + "\"shapeType\": \"RECTANGLE\"," + "\"edgeColor\": \"#000000\"," + "\"fontFamily" + "\": \"Abyssinica SIL\"," + "\"edgeOpacity\": " + "\"100.0\"," + "\"name\": \"Text\"," + "\"x\": \"2930" + ".0\"," + "\"width\": \"163.0\"," + "\"y" + "\": \"1176.0\"," + "\"z\": \"1\"," + "\"fontSize\": " + "\"72\"," + "\"text\": \"Text\"," + "\"height\": \"104.0\"" + "}");
...

        {
            ...
            props.setProperty(COMMAND_LONG_DESCRIPTION,
                    "Adds an image annotation to the specified view.  The view " + "must be specified.");
            props.setProperty(COMMAND_EXAMPLE_JSON, "{" + "\"edgeThickness\": \"0.0\"," + "\"canvas\": " +
                    "\"foreground\"," + "\"fillOpacity\": \"100.0\"," + "\"rotation\": \"0.0\"," + "\"type\": \"org" + ".cytoscape.view.presentation.annotations.ImageAnnotation\"," + "\"uuid\": \"0218f867-008e-48ed" + "-800c-a2fc8863af33\"," + "\"URL\": \"file:/home/scooter/Bliss1.jpg\"," + "\"shapeType\": " + "\"RECTANGLE\"," + "\"edgeColor\": \"#000000\"," + "\"brightness\": \"0\"," + "\"edgeOpacity\": " + "\"100.0\"," + "\"contrast\": \"0\"," + "\"name\": \"Bliss1.jpg\"," + "\"x\": \"2705.0\"," + "\"width\": \"492.0\"," + "\"y\": \"1422.0\"," + "\"z\": \"1\"," + "\"opacity\": \"1.0\"," + "\"height\": \"369.0\"" + "}");
...

        {
            ...
            props.setProperty(COMMAND_LONG_DESCRIPTION, "Updates a bounded text annotation, changing the given " +
                    "properties.");
            props.setProperty(COMMAND_EXAMPLE_JSON, "{" + "\"edgeThickness\": \"1.0\"," + "\"canvas\": " +
                    "\"foreground\"," + "\"fillOpacity\": \"50.0\"," + "\"color\": \"#000000\"," + "\"rotation\": " + "\"0" + ".0\"," + "\"type\": \"org.cytoscape.view.presentation.annotations" + ".BoundedTextAnnotation\"," + "\"fontStyle\": \"0\"," + "\"uuid\": \"8f5d3f59-d023-4522-bfb5" + "-164794b233cf\"," + "\"fillColor\": " + "\"#FF66FF\"," + "\"shapeType\": \"RECTANGLE\"," + "\"edgeColor\": \"#000000\"," + "\"fontFamily" + "\": \"Abyssinica SIL\"," + "\"edgeOpacity\": " + "\"100.0\"," + "\"name\": \"Text\"," + "\"x\": \"2930" + ".0\"," + "\"width\": \"163.0\"," + "\"y" + "\": \"1176.0\"," + "\"z\": \"1\"," + "\"fontSize\": " + "\"72\"," + "\"text\": \"Text\"," + "\"height\": \"104.0\"" + "}");
...

        {
            ...
            props.setProperty(COMMAND_EXAMPLE_JSON, "{" + "\"canvas\": \"foreground\"," + "\"rotation\": \"0.0\"," +
                    "\"name\": \"Group 1\"," + "\"x\": \"2705.0\"," + "\"y\": \"1176.0\"," + "\"z\": \"0\"," +
                    "\"type" + "\": \"org.cytoscape.view.presentation.annotations.GroupAnnotation\"," + "\"uuid\": " + "\"1486946b-f68b-4569-b0ab-80c545348932\"," + "\"memberUUIDs\": " + "\"e643934f-cf94-4ab8-affe-b86675034bee,0218f867-008e-48ed-800c-a2fc8863af33," + "177c3b25-a138-4734-99f4-94316dd555c7,8f5d3f59-d023-4522-bfb5-164794b233cf\"" + "}");
            registerService(bc, factory, TaskFactory.class, props);
        }
        ...
        var vtfFilter = String.format("(| (!(%s=*)) (%s=true))", IN_CONTEXT_MENU, IN_CONTEXT_MENU); // if
        // IN_CONTEXT_MENU is not specified, default to true
        registerServiceListener(bc, vtfListener::addNodeViewTaskFactory, vtfListener::removeNodeViewTaskFactory,
                NodeViewTaskFactory.class, vtfFilter);
        registerServiceListener(bc, vtfListener::addEdgeViewTaskFactory, vtfListener::removeEdgeViewTaskFactory,
                EdgeViewTaskFactory.class, vtfFilter);
        registerServiceListener(bc, vtfListener::addNetworkViewTaskFactory, vtfListener::removeNetworkViewTaskFactory
                , NetworkViewTaskFactory.class, vtfFilter);
        registerServiceListener(bc, vtfListener::addNetworkViewLocationTaskFactory,
                vtfListener::removeNetworkViewLocationTaskFactory, NetworkViewLocationTaskFactory.class);
        registerServiceListener(bc, vtfListener::addCyEdgeViewContextMenuFactory,
                vtfListener::removeCyEdgeViewContextMenuFactory, CyEdgeViewContextMenuFactory.class);
        registerServiceListener(bc, vtfListener::addCyNodeViewContextMenuFactory,
                vtfListener::removeCyNodeViewContextMenuFactory, CyNodeViewContextMenuFactory.class);
        registerServiceListener(bc, vtfListener::addCyNetworkViewContextMenuFactory,
                vtfListener::removeCyNetworkViewContextMenuFactory, CyNetworkViewContextMenuFactory.class);
