...
public class PasteAnnotationStyleTaskFactory implements NetworkViewTaskFactory {
	...
	public TaskIterator createTaskIterator(CyNetworkView view) {
		...
		return new TaskIterator(new PasteAnnotationStyleTask(annotations, clipboard));
	}
