package com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.cyannotator;
...
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.cyannotator.annotations.AbstractAnnotation;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.cyannotator.annotations.AnnotationSelection;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.cyannotator.annotations.ArrowAnnotationImpl;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.cyannotator.annotations.DingAnnotation;
import com.felixkroemer.trace_graph_engineering_tool.renderer.ding.impl.cyannotator.tasks.ReloadImagesTask;
...
public class CyAnnotator implements SessionAboutToBeSavedListener, CustomGraphicsLibraryUpdatedListener {
	...
	public void loadAnnotations(List<String> annotations) {
		...
		try {
			...
			var zOrderMap = new HashMap<DingAnnotation.CanvasID, Map<Integer, DingAnnotation>>();
	...
	private void loadRegularAnnotations(
			...
			Map<DingAnnotation.CanvasID, Map<Integer, DingAnnotation>> zOrderMap
	) {
		for (var s : annotations) {
			...
			var canvas = annotation.getCanvas() == null ? DingAnnotation.CanvasID.FOREGROUND : annotation.getCanvas();
	...
	private void loadArrows(List<Map<String, String>> arrowList, Map<DingAnnotation.CanvasID, Map<Integer, DingAnnotation>> zOrderMap) {
		for (var argMap : arrowList) {
			...
			if (annotation instanceof ArrowAnnotationImpl) {
				...
				DingAnnotation.CanvasID canvas;
...
//					foreGroundCanvas.add(arrow);
					canvas = DingAnnotation.CanvasID.FOREGROUND;
				}
