...
public class LabelSelection {
    ...
    public boolean equals(Object other) {
        if (other instanceof LabelSelection) {
            if (node != null) return Objects.equals(((LabelSelection) other).node.getSUID(), node.getSUID());
            else return Objects.equals(((LabelSelection) other).edge.getSUID(), edge.getSUID());
        }
        return false;
    }
    ...
    @Override
    public int hashCode() {
        if (node != null) return node.getSUID().hashCode();
        else return edge.getSUID().hashCode();
    }
}
