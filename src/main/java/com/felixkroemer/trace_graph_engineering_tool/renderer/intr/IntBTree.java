...
public final class IntBTree implements java.io.Serializable {
     ...
     *                 +---+---+---+---+---+---+---+
     */
    private final static void split(final int newVal, final int[] origBuff, final int[] overflowBuff,
     ...
     * appropriate.
     */
    private final static int distributeFromLeft(final Node leftSibling, final Node thisSibling, final int oldSplitVal
        ...
        if (isLeafNode(leftSibling)) {
            ...
            final int returnThis = leftSibling.data.splitVals[leftSibling.sliceCount - distributeNum - 1];
     ...
     */
    private final static void mergeSiblings(final Node leftSibling, final Node rightSibling, final int splitValue) {
        if (isLeafNode(leftSibling)) {
     ...
     */
    public final IntEnumerator searchRange(final int xMin, final int xMax, final boolean reverseOrder) {
     ...
     * call to this method.
     */
    private final static int searchRange(final Node n, final NodeStack nodeStack, final int xMin, final int xMax,
										 final int minBound, final int maxBound, final boolean reverseOrder) {
        int count = 0;
