package com.felixkroemer.trace_graph_engineering_tool.renderer.graph.render.immed.nodeshape;
...
abstract class AbstractNodeShape implements NodeShape {
     ...
     */
    public boolean computeEdgeIntersection(final float xMin, final float yMin, final float xMax, final float yMax,
                                           final float ptX, final float ptY, final float[] returnVal) {
        ...
        while (!pi.isDone()) {
            ...
            switch (segment) {
                ...
                case PathIterator.SEG_LINETO:
                    ...
                    if (segmentIntersection(intersection, centerX, centerY, ptX, ptY, pt1[0], pt1[1], pt2[0], pt2[1])) {
     ...
     */
    public static boolean segmentIntersection(final float[] returnVal, float x1, float y1, float x2, float y2,
     ...
     *              or a QuadCurve2D.
     */
    private boolean curveIntersection(final float[] returnVal, float x1, float y1, float x2, float y2, Shape curve) {
        ...
        while (!pi.isDone()) {
            ...
            switch (segment) {
                ...
                case PathIterator.SEG_LINETO:
                    ...
                    if (segmentIntersection(intersection, centerX, centerY, x1, y1, pt1[0], pt1[1], pt2[0], pt2[1])) {
                        returnVal[0] = intersection[0];
                        returnVal[1] = intersection[1];
                        return true;
                    } else {
